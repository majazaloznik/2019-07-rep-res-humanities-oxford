...
```{r git, echo=FALSE,fig.cap= "Piled higher and Deeper", out.width = "300px"}
knitr::include_graphics("figures/final-doc.png")
```
...
You don't have to follow one blindly, but at least have a look and deelop your own one and stick to it. Some choices may seem purely aesthetic, but even if so, they increase the readability and understandability of your code and that makes it more reproducible. 
...
So again, this is a work in progress, but you can always do better in docupenting the steps you took and the reasons you took them.

For me my journal lives in the documentation folder and I write it in markdown and knit it to pdf. I also include the diagramme of the makefile in there for a quick overview of the project. 
...
ut more often than not that will not be the case. For the sake of anyone who may try to read your code after you - and don't forget, that mainly includes a future version of yourself, you really want to do them a favour and comment your code liberally. 

Like I said, if you keep your style consistent, and you know, give your variables sensible and meaningful names, you will end up having to write a lot fewer comments, so once you get the hang of it it shouldn't be too troublesome and burdensome. 
...
knitr::include_graphics(here::here("/figures/html.png"))
```
